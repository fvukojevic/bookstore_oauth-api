...
func TestLoginUserInvalidUserJsonResponse(t *testing.T) {
	...
	rest.AddMockups(&rest.Mock{
		...
		RespBody:     `{"id": "1", "first_name": "Ferdo", "last_name": "Vukojevic", "email": "vukojevicf@gmail.com"}`,
	})
...
func TestLoginUserNoError(t *testing.T) {
	...
	assert.EqualValues(t, "Ferdo", user.FirstName)
	assert.EqualValues(t, "Vukojevic", user.LastName)
	assert.EqualValues(t, "vukojevicf@gmail.com", user.Email)
}
